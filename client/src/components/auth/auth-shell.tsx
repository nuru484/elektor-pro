...
// header (title + subtitle only - no logo/wordmark, the SiteHeader above
// already carries the brand), the form body below, and a back link under
// the card. Used by every authentication surface - staff login, 2FA,
