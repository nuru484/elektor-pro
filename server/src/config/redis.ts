...
const cacheMiddleware = (keyGenerator: KeyGeneratorFn) => async (req: Request, res: Response, next: NextFunction) => {
  try {
...
const saveToCache = (key: string, value: JsonValue, ttl: number = 3600): void => {
